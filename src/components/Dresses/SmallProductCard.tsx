    ...
    <>
      <div className="flex col-span-1 flex-col w-full relative group">
        <img
          ...
          alt=""
        />
        <div className=" lg:hidden lg:group-hover:flex bg-black rounded-md w-8 h-8 text-white absolute top-2 right-2 items-center justify-center flex">
          <FaRegHeart />
        </div>
        <div className="lg:hidden lg:group-hover:flex bg-red-600 rounded-md w-12 h-8 text-white absolute top-2 left-2 items-center justify-center flex">
        ...
        <div className="mt-1 md:flex justify-between items-center ">
          <p className="text-xl font-semibold">130 TMT</p>
          <button className="py-2 px-4 md:text-sm w-full md:w-auto justify-center lg:opacity-0 lg:group-hover:opacity-100 rounded-md bg-blue-600 text-white flex items-center gap-2">
              <RiShoppingBag4Line />
              Add
            </button>
        </div>
